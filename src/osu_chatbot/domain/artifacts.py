...
CANONICAL_TOPICS_FILE = "canonical_topics.jsonl"
CANONICAL_TOPICS_REPORT_FILE = "canonical_topics_report.json"
DOCUMENT_ALIASES_FILE = "document_aliases.jsonl"
DOCUMENT_ALIASES_REPORT_FILE = "document_aliases_report.json"
